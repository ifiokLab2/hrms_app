...
const EditClientProfile  = ()=>{
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const response = await axios.put(`${apiUrl}/client/profile/edit/`, formData, {
                headers: {
            ...
            try {
              const response = await axios.get(`${apiUrl}/client/profile/fetch/`,{
                ...
                if (response.data.success) {
                    ...
                    setPreviousPicture(response.data.data.previous_picture);
                    //setPreviousPicture Redirect to the home page
                   
                } else {
                    setTimeout(() => {
                        setEmployeeProfile(response.data.data.exist);
                        navigate('/client/profile/create/'); // Change '/' to the actual path of your home page
